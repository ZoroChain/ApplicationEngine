...
namespace AEServer
{
    public class ConfigManager : IConfigManager
    {
        ...
        public bool init()
        {
            ...
            redisUserCache.source = "127.0.0.1:6382,127.0.0.1:6383";
            ...
            redisGameCache.source = "127.0.0.1:6384,127.0.0.1:6385";
            ...
            redisGameCache.source = "127.0.0.1:6386,127.0.0.1:6387";
            redisGameCache.options = "allowAdmin=true,password=123456";
            redisGameCache.keyExpireTime = 600; // persist db cache with expire time;
            redisDB.Add(redisGameCache);
            ...
            redisGameCache.source = "127.0.0.1:6388,127.0.0.1:6389";
            redisGameCache.options = "allowAdmin=true,password=123456";
